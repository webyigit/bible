...
/* 질문만으로는 막막할 수 있어, 참고할 만한 생각 한 조각을 덧붙인다.
   구절에 특정 주제어가 실제로 들어있으면 그 주제에 맞는 것을
...
const THEME_APPLICATIONS = [
  {keyword:"사랑", thought:"이 말씀에는 '사랑'이라는 주제가 담겨 있어요. 오늘 그 사랑을 누구에게 흘려보낼 수 있을지 생각해보세요."},
  {keyword:"감사", thought:"이 구절은 감사할 이유를 떠올리게 합니다."},
  {keyword:"기도", thought:"이 말씀은 기도로 이어질 수 있는 구절이에요."},
  {keyword:"용서", thought:"이 구절은 용서에 대해 생각해보게 합니다."},
  {keyword:"순종", thought:"이 말씀은 순종이라는 주제를 담고 있어요."},
  {keyword:"인내", thought:"이 구절은 인내를 이야기합니다."},
  {keyword:"믿음", thought:"이 말씀은 믿음에 대해 다시 생각하게 합니다."},
  {keyword:"소망", thought:"이 구절은 소망을 담고 있어요."},
  {keyword:"겸손", thought:"이 말씀은 겸손에 대해 생각해보게 합니다."},
  {keyword:"평안", thought:"이 구절은 평안에 대한 말씀이에요."},
  {keyword:"회개", thought:"이 말씀은 돌이킴(회개)을 이야기합니다."},
  {keyword:"지혜", thought:"이 구절은 지혜를 구하게 합니다."},
  {keyword:"기쁨", thought:"이 말씀은 기쁨에 대해 이야기합니다."},
  {keyword:"두려움", thought:"이 구절은 두려움을 다루고 있어요."},
];
const GENERIC_THOUGHTS = [
  "이 말씀 속에는 지금 내 상황에 비춰볼 만한 부분이 있을 수 있어요.",
  "이 구절에 등장하는 사람의 마음이 어땠을지 한 번 상상해보면 다르게 다가올 수 있어요.",
  "이 말씀은 하나님이 사람을 대하시는 방식을 보여주는 장면일 수 있어요.",
  "이 구절은 짧지만, 표면적인 뜻 너머에 더 깊은 의미가 있을 수 있어요.",
];
function pickThemeOrGeneric(text, bookIdx, chapter, verse){
  ...
  return { thought: GENERIC_THOUGHTS[idx % GENERIC_THOUGHTS.length] };
}
...
document.getElementById("font-plus").addEventListener("click", increaseFontSize);
document.getElementById("font-minus").addEventListener("click", decreaseFontSize);
document.getElementById("today-font-plus").addEventListener("click", increaseFontSize);
document.getElementById("today-font-minus").addEventListener("click", decreaseFontSize);
